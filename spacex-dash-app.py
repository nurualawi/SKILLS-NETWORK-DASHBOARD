...
# Function decorator to specify input and output of the callback
@app.callback(
...
# Callback to update the scatter plot based on dropdown site and payload range
@app.callback(
